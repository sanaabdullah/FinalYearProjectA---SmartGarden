...
<script src="angular-script-3.js"></script>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Soil Moisture Sensor
                        </div>
                        <!-- /.panel-heading -->
...
<div class="col-lg-12" ng-controller="DbController">
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			<div class="alert alert-default navbar-brand search-box">
				<button class="btn btn-primary" ng-show="show_form" ng-click="formToggle()">Add Soil Moisture <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
			</div>
			
		<div class="alert alert-default input-group search-box">
			<span class="input-group-btn">
				<input type="text" class="form-control" placeholder="Search Soil Mositure Details Into Database..." ng-model="search_query">
			</span>
		</div>
		</div>
	</nav>
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<div ng-include src="'forms/addMoist.html'"></div>

		<!-- Include form template which is used to edit and update data into database -->
		<div ng-include src="'forms/editMoist.html'"></div>
	</div>
...
<div class="table-responsive">
	<table class="table table-hover">
		...
		<tr ng-repeat="detail in details| filter:search_query">
			...
			<td>{{detail.MoistName}}</td>
			<td>{{detail.Channel}}</td>
			<td>
				<button class="btn btn-warning" ng-click="editMoistInfo(detail)" title="Edit"><span class="glyphicon glyphicon-edit"></span></button>
			</td>
			<td>
				<button class="btn btn-danger" ng-click="deleteMoistInfo(detail)" title="Delete"><span class="glyphicon glyphicon-trash"></span></button>
			</td>
		</tr>
	</table>
</div>
