...
<script src="angular-script-5.js"></script>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bell fa-fw"></i> Ventilation Fan
                        </div>
                        <!-- /.panel-heading -->
...
<div class="col-lg-12" ng-controller="DbController">
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			<div class="alert alert-default navbar-brand search-box">
				<button class="btn btn-primary" ng-show="show_form" ng-click="formToggle()">Add Fan <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
			</div>
			
		<div class="alert alert-default input-group search-box">
			<span class="input-group-btn">
				<input type="text" class="form-control" placeholder="Search Fan Details Into Database..." ng-model="search_query">
			</span>
		</div>
		</div>
	</nav>
	...
	<div class="col-md-6 col-md-offset-3">
		...
		<div ng-include src="'forms/addFan.html'"></div>

		<!-- Include form template which is used to edit and update data into database -->
		<div ng-include src="'forms/editFan.html'"></div>
	</div>
...
<div class="table-responsive">
	<table class="table table-hover">
		...
		<tr ng-repeat="detail in details| filter:search_query">
			...
			<td>{{detail.GPIO}}</td>
			<td>
				<button class="btn btn-warning" ng-click="editFanInfo(detail)" title="Edit"><span class="glyphicon glyphicon-edit"></span></button>
			</td>
			<td>
				<button class="btn btn-danger" ng-click="deleteFanInfo(detail)" title="Delete"><span class="glyphicon glyphicon-trash"></span></button>
			</td>
		</tr>
	</table>
</div>
