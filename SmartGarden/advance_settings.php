                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form">
                                        ...
                                        <div class="form-group" style="margin-right: 50%;">
                                            <label data-toggle="tooltip" data-placement="right" title="Set the default temperature range for the green house">MAXIMUM</label>
                                            <div class="form-group input-group">
                                                <input type="text" class="form-control" value="40.0">
                                                <span class="input-group-addon">LITRE </span>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-right: 50%;">
                                            <label data-toggle="tooltip" data-placement="right" title="Set the default temperature range for the green house">MISTAKE</label>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon">&#177; </span>
                                                <input type="text" class="form-control" value="5.0">
                                                <span class="input-group-addon">LITRE </span>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-right: 50%;">
                                            <label data-toggle="tooltip" data-placement="right" title="Set the default longest duration of time (to avoid electricity wasting) ">REFRESHING TIME</label>
                                            <div class="form-group input-group">
                                                <select class="form-control">
                                                    <option>1 SEC</option>
                                                    <option>2 SEC</option>
