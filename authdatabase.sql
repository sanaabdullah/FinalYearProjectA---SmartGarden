...
--
-- Table structure for table `auth_database`
--

CREATE TABLE IF NOT EXISTS `auth_database` (
...
INSERT INTO `auth_database` (`uid`, `name`, `email`, `phone`, `password`, `address`, `city`, `created`) VALUES
